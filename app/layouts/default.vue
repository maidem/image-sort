...
const allLinks = [
  { to: "/", label: "Galerie", adminOnly: false },
  { to: "/admin/images", label: "Bilder", adminOnly: true },
  { to: "/admin/categories", label: "Kategorien", adminOnly: true },
];
...
<template>
  <div class="min-h-screen flex flex-col bg-ink-50">
    ...
    <main class="flex-1 mx-auto w-full max-w-6xl px-4 sm:px-6 py-6 sm:py-10">
      <slot />
    </main>
  </div>
</template>
